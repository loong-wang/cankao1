...
class Haoma_m extends FOX_Model
{
	...
	public function count_list_haoma_likets($page, $limit,$cityid,$lock=0,$hao_type,$hao_pinpai=0,$title_hao_types=0,$jiage='',$shuwei='',$hao_redian=0,$hao_endst='',$tedians='',$hao_heyust='',$hao_jixiongs='',$list=0,$list_a=0,$list_b=0,$list_c=0,$searchnum,$b,$lock=0){
