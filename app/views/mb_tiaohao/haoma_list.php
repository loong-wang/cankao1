...
<div class="container">
	<div class="line-middle">
        ...
        <div class="xl12 xs8 xm9 xb9">
			...
			<div class="panel margin-top padding border bg-white border clearfix radius-none">
				
				<dl class="dl-inline haoma-shaixuan hidden-l hidden-s">
					<dt>所属：
					<a href="#">不限</a>
					</dt>
					<dd class="auto"><a class="<?php if($hao_type==0){echo 'active';}?>" href="<?php echo site_url('haoma/yidong/'.$citys['cid']);?>"><?php echo $hao_citys;?>移动</a>
					<a class="<?php if($hao_type==1){echo 'active';}?>" href="<?php echo site_url('haoma/liantong/'.$citys['cid']);?>"><?php echo $hao_citys;?>联通</a>
					<a class="<?php if($hao_type==2){echo 'active';}?>" href="<?php echo site_url('haoma/dianxin/'.$citys['cid']);?>"><?php echo $hao_citys;?>电信</a>
					&nbsp;</dd>
			   </dl>
			   ...
			   <dl class="dl-inline haoma-shaixuan hidden-l hidden-s">
					...
					<?php }}}}?><span class="float-right text-gray text-little">仅供娱乐 (<a href="<?php echo site_url('servers/jxlist/'.$citys['cid']);?>">吉凶列表</a>)</span>
					</dd>
			   </dl>
			</div>
			<div class="haoma-yixuan margin-bottom padding border hidden-l hidden-s">
			您选择了:<?php echo $yixuan;?>
			<span class="float-right"><a href="<?php echo site_url($hao_url.'/'.$citys['cid']);?>">删除所有条件</a></span>
			</div>
