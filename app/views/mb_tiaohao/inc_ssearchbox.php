<div class="bg padding margin-bottom">
        ...
        <td>
            <table class="stable" width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr id="jqss_in" height="25">
				...
				<td><input type="text" id="n9" size="3" maxlength="1" /></td>
				<td><input type="text" id="n10" size="3" maxlength="1" /></td>
				<td><input type="text" id="n11" size="3" maxlength="1" /></td>
				<td style="width:54px;"><a style="cursor:pointer;" onclick="goSearch();"><img src="<?php echo $viewmulu;?>/public/images/ss11.gif" width="54" height="28" /></a></td>
			  </tr>     
			</table>
				</td>
			</tr>
		  <tr height="35">
			<td>
			  ...
			  <tr>
				  <td style="width:220px;">注：按手机号所在位搜索 不确定请留空</td>
				<td><input name="txt_haoma" id="txt_haoma" type="text" /></td>
				<td><input type="checkbox" name="cbox" id="cbox" /> 尾数包含</td>
				<td style="width:54px;"><a style="cursor:pointer;" onclick="goSearchLike();"><img src="<?php echo $viewmulu;?>/public/images/ss22.gif" width="54" height="28" /></a></td>
				</tr>
    </table>
    </td>    
  </tr>
...
function goSearch(){
    ...
    //location.href="<?php echo site_url("search/likea");?>/"+sitecityid+"/"+n;
	location.href="<?php echo site_url("search/liket");?>/"+sitecityid+"/all/"+n;
} 
function goSearchLike(){
    ...
    location.href="<?php echo site_url("search/liket");?>/"+sitecityid+"/all/"+$("#txt_haoma").val()+"/"+cbox;
}
</SCRIPT> 