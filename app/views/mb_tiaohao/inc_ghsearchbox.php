...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:宋体;font-size:12px;">
    <tr>
      ...
      <tr id="sdjqss_in">
        <td><input type="number" name="sn1" id="sn1" min="0" max="9" onkeyup="XinToNext(1)" oninput="checkTextLength(this, 1)" style="width:22px; height:22px;border:1px solid #ccc;border-radius:4px;" /></td>
        ...
        <td style="width:54px;"><a style="cursor:pointer;" onclick="goSearchgh();"><img src="<?php echo $viewmulu;?>/public/images/ss11.gif" width="54" height="28" /></a></td>
      </tr>     
    </table>
        </td>
    </tr>
  <tr height="10">
    <td><hr class="bg-white">
    </td>    
  </tr>
  <tr height="35">
    <td>
      ...
      <tr>
        ...
        <td style="width:54px;"><a style="cursor:pointer;" onclick="goSearchLikegh();"><img src="<?php echo $viewmulu;?>/public/images/ss22.gif" width="54" height="28" /></a></td>
        </tr>
    </table>
    </td>    
  </tr>
...
function goSearchLikegh(){
    ...
    location.href="<?php echo site_url("search/likeb");?>/"+sitecityid+"/"+$("#stxt_haoma").val()+"/"+scbox;
}
