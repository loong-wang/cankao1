...
<div class="container">
	<div class="line-middle">
        ...
        <div class="xl12 xs8 xm9 xb9">
			<div class="line-big margin-top padding">
				<div class="xb5">
				...
				<div class="xb7 text-small">
					...
					<dl class="dl-inline dl-inlines clearfix">
						<dt><strong>号码价格</strong>：</dt>
						<dd><span class="text-sub"><strong>￥<?php echo $haoma['hao_shoujia'];?></strong></span> &nbsp; &nbsp;<strong>话费(需另加)</strong>：<span class="text-green"><strong>￥<?php echo $haoma['hao_huafei'];?></strong></span></dd>
					</dl>
					<dl class="dl-inline dl-inlines clearfix">
						<dt><strong>合计</strong>：</dt>
