					...
					<div class="tab-body">
						<div class="tab-panel active" id="tab-a">
							<div class="view-body margin-top">
								<form accept-charset="UTF-8" method="post" action="<?php echo site_url('member/dailiaddhao/'.$citys['cid']);?>" class="form-x form-auto">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="field">
											<input type="text" class="input input-auto" id="hao_title" name="hao_title" size="30" data-validate="required:必填" placeholder="号码" value="">
											<div class="input-note"></div>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="field">
											<input type="text" class="input" id="hao_jiage" name="hao_jiage" size="30" placeholder="最底价格" data-validate="required:必填,plusinteger:验证没通过" value="">
											<div class="input-note"></div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="field">
											<input type="text" class="input" id="hao_huafei" name="hao_huafei" size="30" placeholder="含话费" data-validate="plusinteger:验证没通过" value="">
											<div class="input-note"></div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="field">
											<input type="text" class="input" id="hao_heyue" name="hao_heyue" size="40" placeholder="合约" data-validate="" value="">
											<div class="input-note"></div>
										</div>
									</div>
