			...
			<?php $this->load->view('member_top');?>
				<div class="tabst">
					...
					<h3 class="text-red"><span class="icon-sign-in"></span> 恭喜您下单成功</h3>
							...
							<p class="bg padding-left border"><a href="<?php echo site_url('member/gouwudd/'.$citys['cid']);?>" class="pull-right margin-right fadein-right"><span class="icon-reorder text-red"></span> 查看所有订单</a><span class="icon-reorder"></span> <strong>订单详情</strong></p>
								<div class="table-responsive">
									<table class="table table-hover text-little">
										...
										<tr>
											...
											<?php if($v['dan_hao_lock_zhifu']==0){echo '-';}else{echo '-支付';}?>
									...
									<p class="bg padding-left border"><span class="icon-comment-o"></span> 注：如订单含议价号码，请等待客服联系或者请您主动与我们客服联系沟通确认价格</p>
