				...
				<div class="tabst">
					...
					<div class="tab-body">
						<div class="tab-panel active" id="tab-a">
							...
							<p class="bg padding-left border"><a class="pull-right margin-right fadein-right" href="<?php echo site_url('member/gouwuche/'.$citys['cid']);?>"><span class="icon-shopping-cart text-red"></span> 我的购物车</a><span class="icon-reorder"></span> <strong>查看已有订单</strong></p>
								<div class="table-responsive">
									<table class="table table-hover text-little">
										...
										<tr>
											<td>
												<span class="text-default text-red"><?php echo $v['dan_hao'];?></span>
											</td>
											...
											<td class="text-right">
												<a class="text-green flash-hover" href="<?php echo site_url('member/gouwudds/'.$citys['cid'].'/'.$v['dan_hao']);?>"><span class="icon-eye "></span> 详情</a>
											</td>
										</tr>
										<?php }}?>
									</tbody>
