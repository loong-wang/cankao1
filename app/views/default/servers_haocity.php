			...
			<div class="tabst bg-foxc alldbg">
				<div class="tab-head padding-top">
					...
					<ul class="tab-nav nav-navicon" id="navbarlist">
						...
						<li class="active"><a id="jixiong" href="<?php echo site_url('servers/haocity/'.$citys['cid']);?>">号码归属地</a> </li>
					</ul>
				</div>
				<div class="bg-white">
					<script language="javascript">$(document).ready(function(){layer.tips('欢迎使用本站工具查询手机号归属地！', '#jixiong', {tips: [3,'#999'],area: ['250px', '30px'],time: 0});})</script> 
					<br />
					<br />
					<br />
					<div class="bg padding-big">
						<form accept-charset="UTF-8" class="form-tips" id="foxform" name="foxform" action="<?php echo site_url('servers/haocity/'.$citys['cid']);?>" method="post" novalidate="novalidate">
						...
						<div class="form-group">
							<div class="field input-inline clearfix">
								...
								<input class="button bg-dot" type="submit" value="查询号码归属地" />
							</div>
