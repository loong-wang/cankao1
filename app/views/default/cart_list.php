				...
				<div class="tabst alldbgy padding-top">
					<div class="tab-head">
						<ul class="tab-nav">
							...
							<p class="bg padding-left border"><a href="<?php echo site_url('cart/alldingdan/'.$citys['cid']);?>" class="pull-right margin-right fadein-right"><span class="icon-reorder text-red"></span> 查看所有订单</a><span class="icon-pencil-square-o"></span> <strong>确认商品信息</strong></p>
								<div class="table-responsive">
									...
									<?php }?>
									<?php if($cart_count>0){?>
									<form accept-charset="UTF-8" method="post" action="<?php echo site_url('cart/dingdan/'.$citys['cid']);?>" class="form-x">
										...
										<div class="form-group">
											...
											<div class="field">
												<input type="text" class="input input-auto" id="dan_tel" name="dan_tel" size="30" placeholder="收货联系电话" data-validate="required:必填,tel:必须为手机号或者电话">
												<div class="input-note"></div>
											</div>
										</div>
										<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="field field-icon-right">
									<div class="xs6">
										<input type="text" class="input" name="captcha_code" placeholder="请填写验证码答案" data-validate="required:请填写验证码答案,ajax#/index.php/user/check_captcha_code/:验证码不正确">
...
$(function() {
	$("#btnAjaxSubmit").click(function() {
		var str='<p class="alert alert-red"><span class="icon-times"></span> <strong>订单提醒：</strong>提交失败，请上传您的实名验证资料。</p>';
		$.get(siteurl+"/mobile/getrenz/<?php echo $fox_scheid;?>", {},
		  function(data){
			if(data){
				if(data==1){
					$("#ajaxForm").ajaxSubmit();
