$(function(){	
	var editora = $('#post_content').FoxEditor({
		...
		'menuConfig': [
			['viewSourceCode', 'removeFormat', 'bold', 'underline',  'foreColor', 'backgroundColor', 'fontSize,createLink','insertHr', 'createLink', 'unLink', 'insertExpression','insertImage', 'insertVideo', 'insertCode']
		],
		//配置多组表情
		'expressions': [{
			'title': '默认',
	...
	var editor = $('#repost_content').FoxEditor({
		pasteUrl: baseurl+"index.php/upload/upload_filest/",
		htmlsUrl: baseurl+"index.php/upload/upload_filess/",
		uploadUrl: baseurl+"index.php/upload/upload_filesd/",
		'menuConfig': [
