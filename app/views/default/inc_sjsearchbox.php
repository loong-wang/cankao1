...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:宋体;font-size:12px;">
    <tr>
      ...
      <tr id="sdjqss_in">
        ...
        <td><a style="cursor:pointer;" onclick="goSearchsj();"><img src="<?php echo $viewmulu;?>/public/images/ss11.gif" width="54" height="22" /></a></td>
      </tr>     
    </table>
        </td>
    </tr>
  ...
  <tr height="35">
    <td>
      ...
      <tr>
        ...
        <td style="width:65px;"><a style="cursor:pointer;" onclick="goSearchLikesj();"><img src="<?php echo $viewmulu;?>/public/images/ss22.gif" width="54" height="22" /></a></td>
        </tr>
    </table>
    </td>    
  </tr>
