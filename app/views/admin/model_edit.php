			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/model/edit/'.$modelinfo['id']);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="ctitle"> 模型名称 </label>

										<div class="col-sm-9">
											<input type="text" id="ctitle" name="title" placeholder="模型名称" class="col-xs-10 col-sm-5" value="<?php echo $modelinfo['title'];?>">
											<?php if(form_error('title')){?><span class="help-block col-sm-reset inline col-xs-12 col-sm-7 red"><?php echo form_error('title');?></span><?php }else{?><span class="help-block col-sm-reset inline col-xs-12 col-sm-7 hidden-480">模型名称</span><?php }?>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="table_name"> 表名称 </label>

										<div class="col-sm-9">
											<input type="hidden" id="otable_name" name="otable_name" value="<?php echo $modelinfo['table_name'];?>" >
											<input type="text" id="table_name" name="table_name" placeholder="表名称" class="col-xs-10 col-sm-5" value="<?php echo $modelinfo['table_name'];?>">
											<?php if(form_error('table_name')){?><span class="help-block col-sm-reset inline col-xs-12 col-sm-7 red"><?php echo form_error('table_name');?></span><?php }else{?><span class="help-block col-sm-reset inline col-xs-12 col-sm-7 hidden-480">表名称</span><?php }?>
										</div>
									</div>
