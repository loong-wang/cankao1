								...
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="margin-left: 25%;">
                                            <div class='col-xs-10 col-sm-5 col-md-2' style="width: 35%;">
	...
	$("#hao_users").click(function(){ 
		...
		if(!hao_user && !hao_time && !hao_city && !hao_type){
			...
			$.ajax({
				...
				data:{hao_user:hao_user,hao_time:hao_time,hao_timea:hao_timea,hao_timeb:hao_timeb,hao_city:hao_city,hao_type:hao_type,<?php echo $this->config->item('csrf_token_name');?>:token,},
				//返回数据的格式
