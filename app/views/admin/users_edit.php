			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/users/edita/'.$userinfo['userid']);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="ugroup"> 角色 </label>
										<div class="col-sm-9">
											<select class="chosen-select form-control" id="group" data-placeholder="选择角色" onchange="getvalue(this)">
											<option value=""></option>
											<?php if($groups){
												foreach($groups as $v){
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="ucity"> 城市 </label>
										<div class="col-sm-9">
