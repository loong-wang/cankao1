			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/memuset/edit/'.$memuinfo['id'].'/'.$memuinfo['mtype']);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								...
								<input type="hidden" id="mtype" name="mtype" value="<?php echo $memuset; ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="1" <?php if($memuinfo['mtype']==1){echo 'checked';}?> >
											...
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="11" <?php if($memuinfo['mtype']==11){echo 'checked';}?> >
											...
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="10" <?php if($memuinfo['mtype']==10){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="help-inline col-xs-12 col-sm-7 col-md-3" id="pid" name="pid">
												<?php if(isset($memust)&&!empty($memust)){?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select multiple="multiple" size="10" name="group_type[]" id="group_type">
												<?php if($memuinfo['mtype']==10){?>
													<option value="10" <?php if(strstr($memuinfo['group_type'],'10')){echo 'selected';}?>>站内通用</option>
												<?php }?>
