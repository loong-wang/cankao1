			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/question/add');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="question_title" name="question_title" placeholder="标题" class="col-xs-10 col-sm-5" value="<?php echo set_value('question_title');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											?>
											<label>
												<input name="question_type" type="radio" class="ace" value="<?php echo $k;?>" <?php if(set_checkbox('question_type',$k)){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php }}?>
											</select><input type="hidden" id="question_city" name="question_city" value="">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="question_name" name="question_name" placeholder="联系人" class="col-xs-10 col-sm-5" value="<?php echo set_value('question_name');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="question_tel" name="question_tel" placeholder="联系电话" class="col-xs-10 col-sm-5" value="<?php echo set_value('question_tel');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control" id="post_content" name="content" rows="10"><?php echo html_entity_decode(set_value('content'));?></textarea>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="question_rename" name="question_rename" placeholder="回复人" class="col-xs-10 col-sm-5" value="<?php echo set_value('question_rename',$this->session->userdata('uname'));?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control" id="repost_content" name="recontent" rows="10"><?php echo html_entity_decode(set_value('recontent'));?></textarea>
