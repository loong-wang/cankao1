			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/news/add');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="news_title" name="news_title" placeholder="标题" class="col-xs-10 col-sm-5" value="<?php echo set_value('news_title');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											?>
											<label>
												<input name="news_type" type="radio" class="ace" value="<?php echo $k;?>" <?php if(set_checkbox('news_type',$k)){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9  no-padding-left">
											...
											<?php }}?>
											</select><input type="hidden" id="news_city" name="news_city" value="">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="news_from" name="news_from" placeholder="出处" class="col-xs-10 col-sm-5" value="<?php echo set_value('news_from');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="form-control" id="post_content" name="content" rows="20"><?php echo html_entity_decode(set_value('content'));?></textarea>
