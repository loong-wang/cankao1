			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/ads/add');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ads_title" name="ads_title" placeholder="广告标题" class="col-xs-10 col-sm-5 col-md-2" value="<?php echo set_value('ads_title');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ads_url" name="ads_url" placeholder="广告链接" class="col-xs-10 col-sm-5" value="<?php echo set_value('ads_url');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php }}?>
											</select><input type="hidden" id="ads_city" name="ads_city" value="">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input class="form-control" id="ads_pic" name="ads_pic" type="text" value="<?php echo set_value('ads_pic');?>" />
