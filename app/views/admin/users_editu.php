			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/users/editu/'.$userinfo['userid']);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="username" name="username" placeholder="会员帐号" disabled="disabled" class="col-xs-10 col-sm-5" value="<?php echo $userinfo['username'];?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php if($groups){
												...
												<option value="<?php echo $v['group_type'];?>" <?php if($v['group_type']==$userinfo['ugroup']){echo 'selected';}?>><?php echo $v['group_name'];?></option>
											<?php }}}?>
											</select><input type="hidden" id="ugroup" name="ugroup" value="<?php echo $userinfo['ugroup'];?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle red"><?php echo form_error('ugroup');?></span>
											</span>
										</div>
									</div>
									<div class="form-group" id="unumsbox" <?php if($userinfo['ugroup']==5){echo 'style="display:;"';}else{echo 'style="display:none;"';}?>>
										<label class="col-sm-3 control-label no-padding-right" for="unums"> 系数 </label>
										<div class="col-sm-9">
											<input type="text" id="unums" name="unums" placeholder="系数" class="col-xs-10 col-sm-5 input-mini spinbox-input" value="<?php echo $userinfo['unums']; ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<option value=""></option>
											<option value="0" <?php if($userinfo['ucity']==0){echo 'selected';}?>>全站</option>
											<?php if($citys){
												foreach($citys as $v){?>
												<option value="<?php echo $v['cid'];?>" <?php if($v['cid']==$userinfo['ucity']){echo 'selected';}?>><?php echo $v['cname'];?></option>
											<?php }}?>
											</select><input type="hidden" id="ucity" name="ucity" value="<?php echo $userinfo['ucity'];?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ucredit" name="ucredit" placeholder="会员积分" class="col-xs-10 col-sm-5 input-mini spinbox-input" value="<?php echo $userinfo['ucredit']; ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="uname" name="uname" placeholder="会员昵称" class="col-xs-10 col-sm-5" value="<?php echo $userinfo['uname']; ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="uzname" name="uzname" placeholder="真实姓名" class="col-xs-10 col-sm-5" value="<?php echo $userinfo['uzname']; ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="uemail" name="uemail" placeholder="会员邮箱" class="col-xs-10 col-sm-5" value="<?php echo $userinfo['uemail']; ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="utel" name="utel" placeholder="会员电话" class="col-xs-10 col-sm-5" value="<?php echo $userinfo['utel']; ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="uqq"> QQ </label>
										<div class="col-sm-9">
											<input type="text" id="utel" name="uqq" placeholder="会员QQ" class="col-xs-10 col-sm-5" value="<?php echo $userinfo['uqq']; ?>">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle red"><?php echo form_error('uqq');?></span>
											</span>
										</div>
									</div>
									...
									<div class="hr hr-16 hr-dotted"></div>
									<div class="form-group">
										<label class="col-xs-3 col-sm-3 control-label no-padding-right" for="ulock"> 状态 </label>
										<input id="ulock" name="ulock" type="hidden" value="<?php echo $userinfo['ulock']; ?>" >

										<div class="col-xs-3 col-sm-3 col-md-2">
												<input id="ulockok" name="ulockok" class="ace ace-switch ace-switch-7" type="checkbox" >
												<span class="lbl" data-lbl="锁&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;开"></span>
										</div>
									</div>
...
jQuery(function($){
	...
	$('#ucredit').ace_spinner({value:0,min:0,max:100000000000,step:10, btn_up_class:'btn-info' , btn_down_class:'btn-info'})
	.closest('.ace-spinner')
	.on('changed.fu.spinbox', function(){
		//alert($('#spinner1').val())
	}); 
	$('.ace-spinner').css({'display':'block'});
	<?php if($userinfo['ulock']==0){?>
	$('#ulockok').prop("checked",true);
	<?php }?>
	$('#ulockok').on('change', function () {
		if(this.checked){ 
			$("input[name='ulockok']").each(function(){this.checked=true;}); 
			$("input[name='ulock']").attr("value",0);
		}else{ 
			$("input[name='ulockok']").each(function(){this.checked=false;}); 
			$("input[name='ulock']").attr("value",1);
		} 
	});
