			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/pages/add');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="pages_title" name="pages_title" placeholder="标题" class="col-xs-10 col-sm-5" value="<?php echo set_value('pages_title');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											?>
											<label>
												<input name="pages_type" type="radio" class="ace" value="<?php echo $k;?>" <?php if(set_checkbox('pages_type',$k)){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php }}?>
											</select><input type="hidden" id="pages_city" name="pages_city" value="">
