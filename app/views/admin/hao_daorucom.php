...
if($page>0){	
	echo '正在导入序列：<font color=red>'.$page.'</font>，总计 <font color=blue>'.$pages.'</font>，请耐心等待完成…… 内存消耗：' . memory_usage();
	echo ('<script type="text/javascript" language="javascript"> setTimeout(function(){window.location.href="' . $location . '";},3000);</script>');
}else{
	echo '恭喜，导入完成';
