			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/haoma/edit/'.$haomainfo['id']);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="hao_title" name="hao_title" placeholder="号码" class="col-xs-10 col-sm-5" value="<?php echo $haomainfo['hao_title'];?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											?>
											<label>
												<input name="hao_type" type="radio" class="ace" value="<?php echo $k;?>" <?php if($haomainfo['hao_type']==$k){echo 'checked';}?> onchange="getvaluest(this.value)" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php if($citys){
												foreach($citys as $v){?>
												<option value="<?php echo $v['cid'];?>" <?php if($haomainfo['hao_city']==$v['cid']){echo 'selected';}?>><?php echo $v['cname'];?></option>
											<?php }}?>
											</select><input type="hidden" id="hao_city" name="hao_city" value="<?php echo $haomainfo['hao_city'];?>">
									...
									<div class="form-group" id="pinpaibox">
										...
										<div class="col-sm-9">
											<div class="radio" id="pinpai_list"><?php echo $haomapinpai;?><input type="hidden" id="hao_pinpai" name="hao_pinpai" value="<?php echo $haomainfo['hao_pinpai'];?>" >
											<a href="#" id="xuan" onclick="xuan(<?php echo $haomainfo['hao_city'];?>)">重选</a>
									...
									<div class="form-group" id="pinpaibox">
										...
										<div class="col-sm-9">
											...
											foreach($pinpai_list as $k => $v){?>
												<label>
													<input name="hao_pinpai" type="radio" class="ace" value="<?php echo $v['pin_num'];?>" <?php if($haomainfo['hao_pinpai']==$v['pin_num']){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="hao_jiage" name="hao_jiage" placeholder="底价" class="col-xs-10 col-sm-5" value="<?php echo $haomainfo['hao_jiage'];?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="hao_huafei" name="hao_huafei" placeholder="含话费" class="col-xs-10 col-sm-5" value="<?php echo $haomainfo['hao_huafei'];?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="hao_heyue" name="hao_heyue" placeholder="合约" class="col-xs-10 col-sm-5" value="<?php echo $haomainfo['hao_heyue'];?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="hao_user" name="hao_user" placeholder="所属" class="col-xs-10 col-sm-5" value="<?php echo $haomainfo['hao_user'];?>">
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="ali_paytype"> 级别 </label>
										<div class="col-sm-9">
											<div class="radio">
											<?php foreach(explode("|",$this->config->item('haojis')) as $k => $v){?>
												<label>
													<input name="hao_dig" type="radio" class="ace" value="<?php echo $k;?>" <?php if($haomainfo['hao_dig']==$k){echo 'checked';}?> >
													<span class="lbl"> <?php echo $v;?></span>
												</label>
											<?php }?>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="ali_paytype"> 状态 </label>
										<div class="col-sm-9">
											<div class="radio">
											<?php foreach(explode("|",$this->config->item('haolocks')) as $k => $v){?>
												<label>
													<input name="hao_lock" type="radio" class="ace" value="<?php echo $k;?>" <?php if($haomainfo['hao_lock']==$k){echo 'checked';}?> >
													<span class="lbl"> <?php echo $v;?></span>
												</label>
											<?php }?>
											<span class="help-block col-sm-reset inline inline hidden-480"></span>
