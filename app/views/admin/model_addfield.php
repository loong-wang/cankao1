			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/model/add_field/'.$modelinfo['id']);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="name" name="name" placeholder="须为字母表示" class="col-xs-10 col-sm-5" value="<?php echo set_value('name');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="chosen-select form-control" id="sj" data-placeholder="数据类型" onchange="getvalue(this)">
												...
												<option value="<?php echo $v['types'];?>"><?php echo $v['title'];?></option>
												<?php }?>
											</select><input type="hidden" id="types" name="types" value="<?php echo set_value('types');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="radio">
												<label>
													<input name="keys" type="radio" class="ace" value="1" <?php if(set_value('keys')==1){echo 'checked';}?> >
													<span class="lbl"> 是</span>
												</label>												
												<label>
													<input name="keys" type="radio" class="ace" value="0" <?php if(set_value('keys')==0){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="remark" name="remark" placeholder="备注" class="col-xs-10 col-sm-5 col-md-3" value="<?php echo set_value('remark');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ords" name="ords" placeholder="排序" class="col-xs-10 col-sm-5 col-md-1" value="<?php echo set_value('ords','0');?>">
