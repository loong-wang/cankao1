			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/webset/zhana');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input class="form-control" id="clogo_a" name="clogo_a" type="text" value="<?php echo $city['clogo'];?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class='input-group col-xs-10 col-sm-5'>
											<input class="form-control" id="ctelpic_a" name="ctelpic_a" type="text" value="<?php echo $city['ctelpic'];?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php if(form_error('cdomain')){?><span class="help-block col-sm-reset inline col-xs-12 col-sm-7 red"><?php echo form_error('cdomain');?></span><?php }else{?><span class="help-block col-sm-reset inline col-md-3 col-xs-12 col-sm-7">支持二级域名，不含 http:// <?php if(isset($city['cdomain'])){?><a href="http://<?php echo $city['cdomain'];?>" target="_blank">预览</a><?php }?></span><?php }?>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
