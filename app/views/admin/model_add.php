			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/model/add');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ctitle" name="title" placeholder="模型名称" class="col-xs-10 col-sm-5" value="<?php echo set_value('title');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="table_name" name="table_name" placeholder="表名称" class="col-xs-10 col-sm-5" value="<?php echo set_value('table_name');?>">
