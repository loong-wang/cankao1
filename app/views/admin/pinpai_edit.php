			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/pinpai/edit/'.$pinpaiinfo['id']);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="pin_title" name="pin_title" placeholder="品牌名称" class="col-xs-10 col-sm-5 col-md-2" value="<?php echo $pinpaiinfo['pin_title'];?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="pin_num" name="pin_num" placeholder="品牌数字" class="col-xs-10 col-sm-5 col-md-2 input-mini spinbox-input" value="<?php echo $pinpaiinfo['pin_num'];?>" disabled="disabled">
											<?php if(form_error('pin_num')){?><span class="help-block col-sm-reset inline col-xs-12 col-sm-7 red"><?php echo form_error('pin_num');?></span><?php }else{?><span class="help-block col-sm-reset inline col-xs-12 col-sm-7 hidden-480">已设置不能更改</span><?php }?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php if($citys){
												foreach($citys as $v){?>
												<option value="<?php echo $v['cid'];?>" <?php if($v['cid']==$pinpaiinfo['pin_city']){echo 'selected';}?>><?php echo $v['cname'];?></option>
											<?php }}?>
											</select><input type="hidden" id="pin_city" name="pin_city" value="<?php echo $pinpaiinfo['pin_city'];?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											?>
											<label>
												<input name="pin_type" type="radio" class="ace" value="<?php echo $k;?>" <?php if($pinpaiinfo['pin_type']==$k){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											?>
											<label>
												<input name="pin_shuxing" type="radio" class="ace" value="<?php echo $k;?>" <?php if($pinpaiinfo['pin_shuxing']==$k){echo 'checked';}?> >
												<span class="lbl"> <?php echo $v;?></span>
											</label>
											<?php }}?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php foreach(explode("|",$this->config->item('pinpais')) as $k => $v){?>
												<label>
													<input name="pin_tezheng[]" type="checkbox" class="ace" value="<?php echo $k;?>" <?php if(strstr(''.$pinpaiinfo['pin_tezheng'].'',''.$k.'')){echo 'checked';}?> >
													<span class="lbl"> <?php echo $v;?></span>
												</label>
											<?php }?>
