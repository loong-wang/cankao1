					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 text-right">
								<a href="<?php echo site_url('admin/memuset/add/1');?>" class="btn btn-xs btn-info">
									<i class="ace-icon fa fa-plus bigger-120"></i> 前台												
								</a>
								<a href="<?php echo site_url('admin/memuset/add/11');?>" class="btn btn-xs btn-info">
									<i class="ace-icon fa fa-plus bigger-120"></i> 后台												
								</a>
								<a href="<?php echo site_url('admin/memuset/add/10');?>" class="btn btn-xs btn-info">
									<i class="ace-icon fa fa-plus bigger-120"></i> 通站												
								</a>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/memuset/add/'.$memuset);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="title" name="title" placeholder="菜单标题，四字最佳" class="col-xs-10 col-sm-5" value="<?php echo set_value('title'); ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="url" name="url" placeholder="操作地址，地址标识" class="col-xs-10 col-sm-5" value="<?php echo set_value('url',$turl); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="ico" name="ico" placeholder="菜单图标样式" class="col-xs-10 col-sm-5" value="<?php echo set_value('ico','fa-circle-o'); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="remark" name="remark" placeholder="菜单的说明，100字内" class="col-xs-10 col-sm-5" value="<?php echo set_value('remark'); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="sort" name="sort" placeholder="" class="col-xs-2 col-sm-2 col-md-1" value="<?php echo set_value('sort','0'); ?>">
											<span class="help-inline col-xs-12 col-sm-7">
									...
									<div class="form-group">
										...
										<input id="mlock" name="mlock" type="hidden" value="1" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="1" <?php if($memuset==1){echo 'checked';}?> >
													<span class="lbl"> 前台菜单</span>
												</label>
											</div>
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="2" <?php if($memuset==2){echo 'checked';}?> >
													<span class="lbl"> 前台操作</span>
												</label>
											</div>
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="11" <?php if($memuset==11){echo 'checked';}?> >
													<span class="lbl"> 后台菜单</span>
												</label>
											</div>
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="12" <?php if($memuset==12){echo 'checked';}?> >
													<span class="lbl"> 后台操作</span>
												</label>
											</div>
											<div class="radio">
												<label>
													<input name="mtype" type="radio" class="ace" value="10" <?php if($memuset==10){echo 'checked';}?> >
													<span class="lbl"> 通用菜单 </span>
												</label>
											</div>
										</div>
									</div>
