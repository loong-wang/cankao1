					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 text-right">
								<a href="<?php echo site_url('admin/memuset/add_act/2');?>" class="btn btn-xs btn-info">
									<i class="ace-icon fa fa-plus bigger-120"></i> 前台												
								</a>
								<a href="<?php echo site_url('admin/memuset/add_act/12');?>" class="btn btn-xs btn-info">
									<i class="ace-icon fa fa-plus bigger-120"></i> 后台												
								</a>
								<a href="<?php echo site_url('admin/memuset/add_act/10');?>" class="btn btn-xs btn-info">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/memuset/add_act/'.$memuset);?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="help-inline col-xs-12 col-sm-7">
												...
												<span class="middle">尽量避免标点符号</span>
											</span>
										</div>
									</div>
