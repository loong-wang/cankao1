			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/webset/zhanp_add');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="space-4"></div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="pingcid"> 号码数据 </label>

										<div class="col-sm-9">
											<select class="chosen-select form-control" id="pingcid" name="pingcid" data-placeholder="选择省区">
												<option value="">请选择</option>
												<?php foreach($citylist as $k => $v){?>
												<option value="<?php echo $v['cid'];?>" <?php if(set_value('pingcid',$city['pingcid'])==$v['cid'] || $city['pingcid']==$v['cid']){echo 'selected';}?>><?php echo $v['cname'];?></option>
												<?php }?>
											</select>
											<span class="middle red"><?php echo form_error('pingcid');?></span>
										</div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input type="hidden" id="cthemes" name="cthemes" placeholder="默认模板" class="col-xs-10 col-sm-5" value="">
