					...
					<div class="page-content">
						...
						<div class="breadcrumbs" id="breadcrumbs">
							<ul class="breadcrumb hidden-480">
								...
								foreach($groups as $v){
								?>
									<a class="btn btn-xs <?php if($ug==$v['group_type']){?>btn-danger<?php }else{?>btn-info<?php }?>" href="<?php echo site_url('admin/users/lista/'.$v['group_type']);?>"><?php echo $v['group_name'];?></a>
								<?php }}?>
							</ul><!-- /.breadcrumb -->

							<!-- #section:basics/content.searchbox -->
							<div class="nav-search" id="nav-search">
								<form accept-charset="UTF-8" class="form-search" action="<?php echo site_url('admin/users/searcha');?>" role="form" method="post" novalidate="novalidate" >
							...
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<th class="hidden-480">所属</th>
											<th class="hidden-480">注册时间</th>
											<th class="hidden-480">最后登陆</th>
											<th class="hidden-480">积分</th>
											<th class="hidden-480">状态</th>
											<th class="text-right">
											<a href="<?php echo site_url('admin/users/adda');?>" class="btn btn-xs btn-info tooltip-info" data-rel="tooltip" title="增加" data-original-title="增加">
										...
										<tr>
											...
											<td class="text-right">
												<div class="hidden-sm hidden-xs btn-group">
													<a href="<?php echo site_url('admin/users/edita/'.$v['userid']);?>" class="btn btn-xs btn-success tooltip-success" data-rel="tooltip" title="编辑" data-original-title="编辑">
														<i class="ace-icon fa fa-pencil bigger-120"></i>
													</a>

													<a href="<?php echo site_url('admin/users/dela/'.$v['userid']);?>" class="btn btn-xs btn-danger tooltip-error" data-rel="tooltip" title="谨慎删除" data-original-title="谨慎删除">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a href="<?php echo site_url('admin/users/edita/'.$v['userid']);?>" class="tooltip-success" data-rel="tooltip" title="编辑" data-original-title="编辑">
																	<span class="green">
															...
															<li>
																<a href="<?php echo site_url('admin/users/dela/'.$v['userid']);?>" class="tooltip-error" data-rel="tooltip" title="谨慎删除" data-original-title="谨慎删除">
																	<span class="red">
																		<i class="ace-icon fa fa-trash-o bigger-120"></i>
																	</span>
																</a>
