			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form accept-charset="UTF-8" id="new_add" action="<?php echo site_url('admin/zifei/add');?>" class="form-horizontal" role="form" method="post" novalidate="novalidate">
								<?php echo csrf_hidden();?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="zf_title" name="zf_title" placeholder="标题" class="col-xs-10 col-sm-5" value="<?php echo set_value('zf_title');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											?>
											<label>
												<input name="zf_type" type="radio" class="ace" value="<?php echo $k;?>" <?php if(set_checkbox('zf_type',$k)){echo 'checked';}?> >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<?php }}?>
											</select><input type="hidden" id="zf_city" name="zf_city" value="">
									...
									<div class="form-group" id="pinpaibox">
										...
										<div class="col-sm-9">
											...
											foreach($pinpai_list as $k => $v){?>
												<label>
													<input name="zf_pinpai" type="radio" class="ace" value="<?php echo $v['pin_num'];?>" <?php if(set_select('zf_pinpai',$v['id'])){echo 'checked';}?> >
