...
include_once(APPPATH."libraries/Wxpayset.php");

define('APPID',$this->wxpayset->wx_config['APPID']); 
define('MCHID',$this->wxpayset->wx_config['MCHID']); 
define('KEY',$this->wxpayset->wx_config['KEY']); 
define('APPSECRET',$this->wxpayset->wx_config['APPSECRET']); 
define('JS_API_CALL_URL',$this->wxpayset->wx_config['JS_API_CALL_URL']); 
define('SSLCERT_PATH',$this->wxpayset->wx_config['SSLCERT_PATH']); 
define('SSLKEY_PATH',$this->wxpayset->wx_config['SSLKEY_PATH']); 
define('NOTIFY_URL',$this->wxpayset->wx_config['NOTIFY_URL']); 
define('CURL_TIMEOUT',$this->wxpayset->wx_config['CURL_TIMEOUT']); 
/**
 * 所有接口的基类
 */
