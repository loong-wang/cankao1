...
<head>
    <title>微信扫码支付</title>
    <link rel="stylesheet" type="text/css" href="/wx/Comm_weixin.css" />
    <link rel="stylesheet" type="text/css" href="/wx/WeixinPay.css" />
    <script type="text/javascript" src="/wx/JQuery132.js"></script>
...
<body>
    ...
    <div class="wx_header">
        <div class="wx_logo"><img src="/wx/wxlogo_pay.png" /></div>
    </div>
    <div class="weixin">
        <div class="weixin2">
                    ...
                    <div class="pay_box qr_default">
                        <div class="area_bd"><span class="wx_img_wrapper"  id="qr_box">
						   ...
						   <div id="resmsgdiv"></div>
                            <img style="left: 50%; opacity: 0; display: none; margin-left: -101px;" class="guide pngFix" src="/wx/wxwebpay_guide.png" alt="" id="guide" />
                        </span>
	...
	<script src="/wx/qrcode.js"></script>
	<script>
			  ...
			  $.ajax({
				...
				success: function(res){
				    if(res.code!='999'){
						if(res.code=='4'){
							alert(res.msg);
							window.location.href="/user/order_weixin.php?dan_hao="+d;
